...
public class forgot_password_admin implements ActionListener {
 ...
 if(e.getSource() == search) {
	 ...
	 String query = "Select * from admin where phone_num ='"+number_text.getText()+"' and username = '"+username_text.getText()+"'";
	 ...
	 String sql = "update admin set password='"+password1_text.getText()+"' where username = '"+username_text.getText()+"'";
	 dbOperation1 db = new dbOperation1();
