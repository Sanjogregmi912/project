...
// for my doctor option
	...
	paitentwindow(){
		...
		name2.setText("Name: "+" Dr " +"Ram Sharma ");
		...
		name6.setText("Name: "+" Dr " +"Bibek  Dangol ");
		department6.setBounds(380,680,200,30);
		department6.setText("Department: "+ "OPD");
		...
		name8.setText("Name: " +" Dr "+"Rajal Shrestha ");
		department8.setBounds(980,680,200,30);
		department8.setText("Department: "+ "Dental");
		...
		ImageIcon image6 = new ImageIcon("back_turn.jpg");
		label_rep.setIcon(image6);
		...
		mydetail_btn.setForeground(Color.black);
		mydetail_btn.setBackground(Color.white);
		...
		my_turn_btn.setForeground(Color.black);
		my_turn_btn.setBackground(Color.white);
