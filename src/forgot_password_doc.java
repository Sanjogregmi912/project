...
public class forgot_password_doc implements ActionListener {
 ...
 if(e.getSource() == search) {
	 ...
	 String query = "Select * from doc where contact ='"+number_text.getText()+"' and username = '"+username_text.getText()+"'";
	 ...
	 String sql = "update doc set password='"+password1_text.getText()+"' where username = '"+username_text.getText()+"'";
	 dbOperation1 db = new dbOperation1();
